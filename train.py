...
def main():
    ...
    print(gpus)
    model = DataParallelModel(deeplab, device_ids=gpus)
    model.cuda()
    # print('check model ', model.is_cuda)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # break
        print('try to save')
        # torch.save(model.state_dict(), osp.join(args.snapshot_dir, 'try_' + str(epoch) + '.pth'))
